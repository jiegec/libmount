...
fn main() {
    ...
    let mut readonly = false;
    {
        ...
        ap.refer(&mut source)
            .add_argument("source", Parse, "Source directory for bind mount")
            .required();
        ap.refer(&mut target)
            .add_argument("target", Parse, "Target directory for bind mount")
            .required();
        ...
        ap.refer(&mut readonly)
            .add_option(&["--readonly"], StoreTrue, "Readonly mount");
